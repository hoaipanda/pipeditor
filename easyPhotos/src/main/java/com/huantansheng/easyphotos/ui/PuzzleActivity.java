...
import com.huantansheng.easyphotos.ui.adapter.BackgroundAdapter;
...
public class PuzzleActivity extends AppCompatActivity implements View.OnClickListener, PuzzleAdapter.OnItemClickListener, BackgroundAdapter.OnItemClickListener {
    ...
    private TextView tvTemplate, tvBg;
    ...
    private void initIvMenu() {
        ...
        tvBg = (TextView) findViewById(R.id.tv_text_sticker);
        ...
        setClick(ivRotate, ivCorner, ivPadding, fab, tvBg, tvTemplate);
    ...
    private void initRecyclerView() {
        ...
        listBg = getBackground(this);
        Log.e("hoaiii", "listBg" + listBg.size());
        backgroundAdapter = new BackgroundAdapter(this, listBg);
    }
    ...
    public static ArrayList<String> getBackground(Context context) {
        ...
        try {
            images = context.getAssets().list("background");
        } catch (IOException e) {
            e.printStackTrace();
        }
        stickerList = new ArrayList<String>(Arrays.asList(images));
        return stickerList;
    }
    ...
    public void onClick(View view) {
        ...
        if (R.id.tv_back == id) {
            ...
            tvBg.setTextColor(ContextCompat.getColor(this, R.color.easy_photos_fg_primary));
            rvPuzzleTemplet.setAdapter(puzzleAdapter);

        } else if (R.id.tv_text_sticker == id) {
            tvBg.setTextColor(ContextCompat.getColor(this, R.color.easy_photos_fg_accent));
            tvTemplate.setTextColor(ContextCompat.getColor(this, R.color.easy_photos_fg_primary));

            rvPuzzleTemplet.setAdapter(backgroundAdapter);
            backgroundAdapter.setOnItemClickListener(new BackgroundAdapter.OnItemClickListener() {
                ...
                public void onItemClick(String stickerValue) {
                    Bitmap bm = getBitmapFromAsset(PuzzleActivity.this, "background/" + stickerValue);
                    BitmapDrawable background = new BitmapDrawable(bm);
                    puzzleView.setBackgroundDrawable(background);
                }
            });
        } else if (R.id.fab == id) {
            processBottomLayout();
    ...
    private void savePhoto() {
        ...
        stickerModel.save(this, mRootView, puzzleView, puzzleView.getWidth(), puzzleView.getHeight(), saveDirPath, saveNamePrefix, true, new SaveBitmapCallBack() {
            ...
            public void onSuccess(File file) {
                ...
                intent.putExtra(EasyPhotos.RESULT_PATHS, file.getAbsolutePath() + "/PipEditor");

                Photo photo = new Photo(file.getName(), file.getAbsolutePath() + "/PipEditor", file.lastModified() / 1000, puzzleView.getWidth(), puzzleView.getHeight(), file.length(), "image/png");
